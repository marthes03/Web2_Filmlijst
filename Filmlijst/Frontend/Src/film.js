...
export class SciFiFilm extends Film {
  ...
  render() {
    ...
    tag.innerHTML = `<strong>Tijdsetting: ${this.tijdSetting}</strong>`;
...
export class FantasyFilm extends Film {
  ...
  render() {
    ...
    const tag = document.createElement('p');
    tag.innerHTML = `<strong>Fantasiewereld: ${this.fantasieWereld}</strong>`;
    kaart.appendChild(tag);
    return kaart;
  }
}
...
export class RomanceFilm extends Film {
  ...
  render() {
    ...
    const tag = document.createElement('p');
    tag.innerHTML = `<strong>Relatietype: ${this.relatieType}</strong>`;
    kaart.appendChild(tag);
    return kaart;
  }
}
